 ...
 for (let index = 0; index < glasses_area.length; index++) {
  $('.subMenu-option[value="' + index + '"]').click(function (e) {
   ...
   function glassesChange(index) {
    ...
    // $('.banner-img.left').html(`<img src="https://raw.githubusercontent.com/hexschool/2022-web-layout-training/380a3830c5ec79e65f02eb756c218209a90ebe10/week3-4/${glasses_area[index].img1}" />`)
    // $('.banner-img.right').html(`<img src="https://raw.githubusercontent.com/hexschool/2022-web-layout-training/380a3830c5ec79e65f02eb756c218209a90ebe10/week3-4/${glasses_area[index].img2}" />`)
   }
